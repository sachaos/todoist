...
type ProjectOrders []ProjectOrder

func (a ProjectOrders) Len() int           { return len(a) }
func (a ProjectOrders) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }
func (a ProjectOrders) Less(i, j int) bool { return a[i].Num < a[j].Num }
